...
public class ShellUtil {
     ...
     * @return
     * @see cm.android.cmd.ShellUtil#exec(String[], boolean, boolean)
     */
     ...
     * @param isNeedResultMsg whether need result msg
     * @return <ul>
     * <li>if isNeedResultMsg is false, {@link cm.android.cmd.ShellUtil.CommandResult#successMsg}
     * is null and {@link cm.android.cmd.ShellUtil.CommandResult#errorMsg} is null.</li>
     * <li>if {@link cm.android.cmd.ShellUtil.CommandResult#result} is -1, there maybe some
     * excepiton.</li>
     * </ul>
     */
    public static CommandResult exec(String[] commands, boolean isRoot,
     ...
     * result of command,
     * <ul>
     * <li>{@link cm.android.cmd.ShellUtil.CommandResult#result} means result of command, 0 means normal,
     * else means error, same to excute in linux shell</li>
     * <li>{@link cm.android.cmd.ShellUtil.CommandResult#successMsg} means success message of command
     * result</li>
     * <li>{@link cm.android.cmd.ShellUtil.CommandResult#errorMsg} means error message of command result</li>
     * </ul>
     *
