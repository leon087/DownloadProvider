...
public class DownloadManager {
    ...
    public static final String[] UNDERLYING_COLUMNS = new String[]{
            ...
            Downloads.Impl.COLUMN_TOTAL_BYTES + " AS "
                    + COLUMN_TOTAL_SIZE_BYTES,
            Downloads.Impl.COLUMN_LAST_MODIFICATION + " AS "
    ...
    public static class Request {
         ...
         * @return this object
         * @throws IllegalStateException If the external storage directory cannot be found or
         *                               created.
         */
        ...
        ContentValues toContentValues(String packageName) {
            ...
            if (mDestinationUri != null) {
                ...
                values.put(
                        Downloads.Impl.COLUMN_DESTINATION,
                        (this.mUseSystemCache) ? Downloads.Impl.DESTINATION_SYSTEMCACHE_PARTITION
            ...
            putIfNonNull(values, Downloads.Impl.COLUMN_DESCRIPTION,
                    mDescription);
            ...
            values.put(Downloads.Impl.COLUMN_ALLOW_WRITE, mWriteAllowed);
    ...
    public void pauseDownload(long... ids) {
        ...
        values.put(Downloads.Impl.COLUMN_NO_INTEGRITY, 1);
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                int status = cursor.getInt(cursor
                        .getColumnIndexOrThrow(COLUMN_STATUS));
                if (DownloadManager.STATUS_SUCCESSFUL == status) {
                    ...
                    if (destination == Downloads.Impl.DESTINATION_CACHE_PARTITION
                        ...
                        String path = cursor.getString(cursor
                                .getColumnIndexOrThrow(COLUMN_LOCAL_FILENAME));
        ...
        try {
            ...
            while (cursor.moveToFirst()) {
                return cursor.getString(cursor
                        .getColumnIndexOrThrow(COLUMN_MEDIA_TYPE));
            }
        } finally {
            if (cursor != null) {
                cursor.close();
     ...
     * @param description             the description that would appear for this file in Downloads
     *                                App.
     * @param isMediaScannerScannable true if the file is to be scanned by MediaScanner. Files
     *                                scanned by MediaScanner appear in the applications used to
    ...
    public long addCompletedDownload(String title, String description,
        ...
        values.put(
                ...
                (showNotification) ? Request.VISIBILITY_VISIBLE_NOTIFY_ONLY_COMPLETION
        ...
        public long getLong(int columnIndex) {
            if (getColumnName(columnIndex).equals(COLUMN_REASON)) {
                return getReason(super
                        .getInt(getColumnIndex(Downloads.Impl.COLUMN_STATUS)));
