...
import static cm.android.download.provider.Downloads.Impl.STATUS_UNHANDLED_HTTP_CODE;
import static cm.android.download.provider.Downloads.Impl.STATUS_UNHANDLED_REDIRECT;
