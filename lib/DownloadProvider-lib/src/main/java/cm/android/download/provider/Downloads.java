...
package cm.android.download.provider;
...
public final class Downloads {
    ...
    public static final class Impl implements BaseColumns {
        ...
        // public static final Uri ALL_DOWNLOADS_CONTENT_URI = Uri
        // .parse("content://downloads/all_downloads");
         ...
         */
        public static final Uri PUBLICLY_ACCESSIBLE_DOWNLOADS_URI = Uri
     ...
     */
    private static final String QUERY_WHERE_CLAUSE = Impl.COLUMN_NOTIFICATION_PACKAGE
            + "=? AND " + Impl.COLUMN_NOTIFICATION_CLASS + "=?";
